...
SELECT T.CODFILIAL,
       ...
       ('NF ' || T.DUPLIC || ' - ' || C.CLIENTE) AS HISTORICO --PARA TRAZERMOS A INFORMAÇÃO DO CLIENTE DA VENDA ORIGINAL
  FROM PCPREST T
 ...
 WHERE T.NUMTRANS IS NULL
   ...
   AND K.CODCLICC IS NULL -- NÃO CONSIDERAR DUPLICATAS JÁ DESDOBRADAS PARA O CARTÃO/MRT QUE TENHAM SOFRIDO NOVO DESDOBRAMENTO
